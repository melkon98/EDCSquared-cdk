...
import { AuthorizationType, FieldLogLevel } from 'aws-cdk-lib/aws-appsync';
...
import { DEPLOYMENT_LOGIC_ID, HOSTING_BUCKET_NAME } from './static/constants';
...
export class CoreStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const gqlApi = new appsync.GraphqlApi(this, 'gql-api', {
      name: 'edcsquared',
      ...
      ), // Replace with the path to your GraphQL schema file
      authorizationConfig: {
    ...
    // gqlApi.addDynamoDbDataSource('approvedAds', ApprovedAdsTable(this));
    // gqlApi.addDynamoDbDataSource('bestPractices', BestPracticesTable(this));
    // gqlApi.addDynamoDbDataSource('brandBriefs', BrandBriefsTable(this));
    // gqlApi.addDynamoDbDataSource('brandProfiles', BrandProfilesTable(this));
    // gqlApi.addDynamoDbDataSource(
    //   'creativeRequests',
    //   CreativeRequestsTable(this)
    // );
    // gqlApi.addDynamoDbDataSource(
    //   'creativeRequestEarnings',
    //   CreativeRequestEarningsTable(this)
    // );
    // gqlApi.addDynamoDbDataSource(
    //   'userPaymentDetails',
    //   UserPaymentDetailsTable(this)
    // );
    // gqlApi.addDynamoDbDataSource('userProfiles', UserProfilesTable(this));
    // gqlApi.addDynamoDbDataSource(
    //   'userTransactions',
    //   UserTransactionsTable(this)
    // );
    // gqlApi.addDynamoDbDataSource('userWallets', UserWalletsTable(this));
    ...
    // const hostedZone = new HostedZone(this, 'AppHostingZone', {
    //   zoneName: 'edcsquared.io',
    // });
    //
